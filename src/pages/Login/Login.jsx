...
import logi from '../../assets/assets/images/login/login.svg'
...
const Login = () => {
  ...
  <div className=" w-full border bg-base-100 rounded-xl">
      ...
      <form onSubmit={loginHandler} className="card-body p-10">
        ...
        <div className="form-control mt-6">
          <button type='submit' className="btn btn-primary text-white bg-[#FF3811] border-none">Sign In</button>
        </div>
       <div className='text-center'>
        ...
        <p className='my-8'>Don&lsquo;t Have an account? <Link to="/register" className='font-semibold text-[#FF3811]'>Sign In</Link></p>
       </div>
      </form>
    </div>
